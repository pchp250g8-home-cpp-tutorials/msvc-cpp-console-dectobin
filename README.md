...
Программа делает следующее:
  ...
  5. Выполняется цикл с предусловием:
     ...
     c) Он переводится в строку (символ). Этот символ прибавляется в конец строки.
     d) Времменая переменная делится на 2
  6. Если после завершения цикла строка остаётся пустой, она заменяется на символ "0".
  7. На экран выводится введённое число и его двоичное число (строка, которая была введена в пункте 3).
